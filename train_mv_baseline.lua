...
cmd:option('-cnn_model', './models/pre_trained_net/densenet-201.t7', 'path to cnn model that will be the base net for mv cnn:./models/pre_trained_net/densenet-201.t7')
-- densenet:
